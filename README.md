...
- **Edit in place**: move and resize any element, recolor its fill or stroke as hex (the editor names the element's color space), and even retype text. Changes are written straight back into the content stream, with full undo and redo.
